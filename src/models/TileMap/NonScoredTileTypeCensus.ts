...
/**
 * Represents a list of nonresource tile types, and how many of each there are
 */
 export class NonScoredTileTypeCensus {
    private _data: Record<BoardTileType, number>;

    /**
     * Creates a new NonResourceTileTypeCensus instance
     */
    ...
    /**
     * @param tileType The nonresource tile type to count
    ...
    /**
     * @returns the total number of nonresource tile types, i.e. the sum of all the counts
     */
    totalCount(): number {
    ...
    /**
     * @returns a flattened array of the nonresource tile types, i.e. each tile type repeated n times, where n is its count
     */
    flatten(): BoardTileType[] {
        let flattened: BoardTileType[] = [];

        // loop through every nonresource tile type included in this census
